...
urlpatterns = [
    ...
    path("ui/partials/summary/", ui_views.summary_partial, name="ui-summary-partial"),
    path("ui/partials/answered/", ui_views.answered_partial, name="ui-answered-partial"),
    path("ui/partials/unanswered/", ui_views.unanswered_partial, name="ui-unanswered-partial"),
